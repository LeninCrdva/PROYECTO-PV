 ...
 * @author Lenin
 */
public class VistaLabor extends javax.swing.JPanel {

    /**
     * Creates new form VistaLabor1
     */
    public VistaLabor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tbllabor.setFocusable(false);
        tbllabor.setIntercellSpacing(new java.awt.Dimension(0, 0));
        tbllabor.setRowHeight(25);
        tbllabor.setSelectionBackground(new java.awt.Color(232, 57, 95));
        tbllabor.setShowVerticalLines(false);
        tbllabor.getTableHeader().setReorderingAllowed(false);
